...
Pollen deposition on *Succisa pratensis* in a dynamic plant-pollinator network Jakub Štenc and company
:::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
In 2024 lower abundance of heterospecific neigboors! 
:::
</h2>
::::
:::::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
In 2024 lower heterospecific pollen grains deposited! 
:::
</h2>
::::
:::::
...
![](images/logoPrF1.png){.absolute bottom="8%" left="0%" width="184"} 
![](images/pyl.png){.absolute bottom="8%" right="5%" width="184"}
