...
for (i in 22:24) {
  ...
  plot(
    proj$proj1,
    layout = l,
    edge.width = E(proj$proj1)$weight,
    vertex.label = NA,  # Suppress default labels
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
Lower and lower abundance of heterospecific neigboors!
:::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
Not a huge difference between years!
:::
...
## Annual variation in pollen deposition
...
plot_by_year <- plot_pollen_deposition(colors = c(Conspecific = "lightseagreen", Heterospecific = "lightcoral"),   add_stats = FALSE)
print(plot_by_year)
```
:::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
In 2024 slightly less heterospecific pollen grains deposited!
:::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
But we know something from our previous work.
:::
...
::: {style="background-color: rgba(0, 0, 0, .8); backdrop-filter: blur(5px); box-shadow: 0 0 1rem 0 rgba(0, 0, 0, .5); border-radius: 5px;;text-align:center;"}
Does it affect the structure of pollen deposition too?
:::
...
![](images/IMG_1108.jpg){fig-align="center" width="800"}
